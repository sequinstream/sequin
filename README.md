...
| Kinesis | ✅ Real-time streaming<br />✅ Backfill existing rows | Send messages to Amazon SQS queues |
| Typesense | ✅ Real-time streaming<br />✅ Backfill existing rows | Send messages to Amazon SQS queues |
| Elasticsearch | ✅ Real-time streaming<br />✅ Backfill existing rows | Send messages to Amazon SQS queues |
