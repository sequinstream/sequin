...
<Frame>
  <img style={{maxWidth: "800px"}} src="/images/guides/change-capture-pipelines/wal-pipeline-arch.png" alt="Architecture diagram of Change Capture Pipelines, with the source table on the left and the event log table on the right" />
</Frame>
...
<Frame>
  <img style={{maxWidth: "500px"}} src="/images/guides/change-capture-pipelines/source-configuration.png" alt="Source configuration widget, showing a list of tables to choose from" />
</Frame>
...
<Frame>
  <img style={{maxWidth: "800px"}} src="/images/guides/change-capture-pipelines/filter-configuration.png" alt="Insert, delete, and update radio group, followed by a column filter widget" />
</Frame>
...
<Frame>
  <img style={{maxWidth: "800px"}} src="/images/guides/change-capture-pipelines/destination-configuration.png" alt="Destination configuration widget, showing a list of tables to choose from, and a button to create a new event table" />
</Frame>
...
<Frame>
  <img style={{maxWidth: "500px"}} src="/images/guides/change-capture-pipelines/create-event-table-modal.png" alt="The create event table modal, showing some configuration options and a series of SQL DDL commands to create the table" />
</Frame>
