...
description: Sequin brings unique new capabilities to Postgres. At its core, Sequin is a material improvement over native Postgres tools like triggers, LISTEN/NOTIFY, and logical replication. But thanks to Sequin's streaming capabilities, you can use it to replace other streaming systems like Kafka.
icon: "list-check"
iconType: "solid"
---
...
So, Sequin is kind of like combining your Postgres table with SQS, like you might do with a system like [Debezium](#debezium).
