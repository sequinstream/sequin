...
The **Consume API** allows you to pull rows from your Sequin Streams using HTTP endpoints. It follows the popular **consumer group** pattern, providing scalable and fault-tolerant processing of your data.
