---
title: 'Ingesting webhooks'
description: With the `webhook` source, Sequin turns webhooks into a message queue. This means you can stream webhooks from any service to your app with at-least-once delivery.
---

<Note>This guide assumes you have already created a stream and a consumer. If not, please see the [quickstart](/quickstart).</Note>
...
Now that webhooks are in your stream, you can consume them with a [consumer](/core/consumers).
