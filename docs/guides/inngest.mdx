...
<Steps titleSize="h3">
    <Step title="Connect Sequin to your database">
        ...
        <Note>
        If you need step-by-step connection instructions to connect Sequin to your database, check out our [quickstart guide](/docs/quickstart).
        </Note>
    </Step>
    ...
    7. Click the **Create Consumer** button. Sequin will varify your database is set up properly and may give you another SQL command to run to ensure every new user is captured.
    </Step>
</Steps>
...
- Tailor your [Sequin consumers](http://localhost:4000/core-concepts#consumers) to your use case.
