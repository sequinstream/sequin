...
Now that you have a Stream set up, you can consume data using Sequin's [Consume API](/consume/consume-api/overview), [webhooks](/how-sequin-works#webhooks), or [Sync API](/how-sequin-works#sync-api) (coming soon).
