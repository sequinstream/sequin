...
description: "Add contextual metadata to your database changes"
---
...
The annotations will be included in the `metadata.transaction_annotations` field of all [change messages](/reference/messages#change-messages) in that transaction:
