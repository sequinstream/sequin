...
1. **Source table(s)**: The table(s) or schema(s) in Postgres that contain the data you want to cache
...
<Steps>
  <Step title="Select the source">
    Select the table(s) or schema(s) containing the data you want to cache.
