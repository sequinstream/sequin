...
By the end of this guide, you'll have a table that stores change messages. Then, you can stream those changes to a Sequin [sink](/reference/sinks/overview) and have the ability to [backfill changes](/reference/backfill) at any time.
