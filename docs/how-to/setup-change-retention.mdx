...
description: 'Store and retain change messages in a database table'
---

This guide shows you how to set up [change retention](/reference/change-retention) in Sequin to store change messages (inserts, updates, and deletes) in your database.

By the end of this guide, you'll have a table that stores change messages. Then, you can stream those changes to a Sequin [sink](/reference/sinks/overview) and have the ability to [backfill changes](/reference/backfills) at any time.
