...
You can use a [Change Capture Pipeline](reference/change-retention) to persist changes to a table in your database. Then, you can stream _that_ table to your webhook endpoint. This gives you the power to [run backfills](/reference/backfills)/replays of recent changes at any times.
