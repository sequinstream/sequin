---
title: "How to stream Postgres to Redis"
sidebarTitle: "Stream to Redis"
...
- **Setup a processor**
   ...
   Refer to the [Redis sink reference](/reference/sinks/redis) for the shape of messages that Sequin will publish to Redis.
...
- **Advanced configuration**
   ...
   For more about how Redis sinks work, see the [Redis sink reference](/reference/sinks/redis).
