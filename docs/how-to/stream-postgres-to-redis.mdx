...
3. Have a Redis instance ready to go
...
For advanced configuration and more about how Redis sinks work, see the [Redis sink reference](/reference/sinks/redis).
