...
<Steps>
  ...
  <Step title="Specify max ack pending">
    ...
    This setting helps prevent your consumer group from getting overloaded with messages. The right value depends on your consumer group's processing capacity.
  </Step>
  ...
  <Step title="Specify max waiting">
    ...
    This setting helps manage resource utilization and prevent excessive polling. The right value depends on how many parallel consumers you expect to have in your consumer group.
  </Step>
