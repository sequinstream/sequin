...
description: "Learn how to use `sequin.yml`, Sequin's CLI, and the management API to test your sinks locally and in CI."
---

This guide explains the best practices for unit testing your code with Sequin as well as testing Sequin in a CI environment.
