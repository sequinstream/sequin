...
description: "Trigger code when Postgres rows change"
---
...
<Steps>
  ...
  <Step title='Leave the default for "Message grouping"'>
    ...
    <Note>
      This ordering applies to how Sequin _writes_ changes to your sink. All sinks except [Redis streams](/reference/sinks/redis) support ordered _processing_ as well.
    </Note>
  </Step>
...
<Info>
  ...
  * [SQS](/how-to/stream-postgres-to-sqs)
  * [Kafka](/how-to/stream-postgres-to-kafka)
  * [Redis](/how-to/stream-postgres-to-redis)
  * [webhooks](/how-to/stream-postgres-to-a-webhook-endpoint)
  * [Sequin Stream](/how-to/stream-postgres-to-sequin-stream)
</Info>
