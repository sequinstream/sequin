...
Sequin streams the latest version of rows as they're created and updated in a table. Because it streams rows from tables, and deleted rows are removed from tables, Sequin can't "see" deleted rows.
