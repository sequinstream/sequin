...
description: Discover how to use Sequin to build real-time Postgres change data capture pipelines. Use Sequin to power workflows, sync rows, and manage caches.
icon: "book-open"
iconType: "solid"
---
...
<CardGroup cols={3}>
  <Card title="Trigger workflows" icon="bolt" href="/how-to/trigger-automated-workflows" >
  ...
  <Card title="Database sync" icon="database" href="/how-to/replicate-tables">
    Keep tables synchronized across different database instances in real-time.
  </Card>
  <Card title="Derived tables" icon="table" href="/how-to/replicate-tables">
    Create and maintain derived tables based on changes to source tables.
  </Card>
  <Card title="Cache management" icon="memory" href="/how-to/maintain-caches">
    Keep application caches up-to-date by streaming database changes.
  </Card>
  <Card title="Redis integration" icon="server" href="/how-to/stream-postgres-to-redis">
...
<CardGroup cols={2}>
  ...
  <Card title="Azure EventHubs Quickstart" icon="azure" href="/quickstart/azure-event-hubs" horizontal>
