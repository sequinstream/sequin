...
Changes are sent as messages via HTTP [push](/core-concepts#push-consumers) (webhooks) or [pull](/core-concepts#pull-consumers) (SQS-like). This means it's easy to integrate Sequin into your application or another service (like Lambdas, Inngest, Vercel, etc).
