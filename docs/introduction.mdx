...
To stream data, you'll create [Streams](/how-sequin-works#streams) for each table you want to stream. Then, you'll consume rows from the Stream using Sequin's [Consume API](/how-sequin-works#consume-api), [webhooks](/how-sequin-works#webhooks), or [Sync API](/how-sequin-works#sync-api).
