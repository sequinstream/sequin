...
<Card title="Kafka Quickstart" icon="server" href="/quickstart/kafka" horizontal>
  Stream changes to a Kafka topic in about 3 minutes.
</Card>

<Card title="Redis Quickstart" icon="database" href="/quickstart/redis" horizontal>
  Stream changes to a Redis stream in about 3 minutes.
</Card>

<Card title="Sequin Stream Quickstart" icon="stream" href="/quickstart/sequin-stream" horizontal>
