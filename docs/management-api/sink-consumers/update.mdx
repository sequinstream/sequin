...
<ParamField body="annotations" type="object">
  ...
  This data can be referenced in your [transform](/reference/transforms), to have one function include sink-specific data that function is attached to multiple sinks.
</ParamField>
