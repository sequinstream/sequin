...
1. **Source table(s)**: The table(s) or schema(s) in Postgres that you want to capture changes from.
...
<Steps>
  <Step title="Select the source">
    Select the table(s) or schema(s) you want to capture changes from.
  </Step>
