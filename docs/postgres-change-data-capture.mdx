...
<Steps>
  ...
  <Step title="Select the message type">
    Leave the default option selected to receive the full payload for each change.
    You can add a [transform](/reference/transforms) later if you only need specific fields.
  </Step>
...
<CardGroup>
  <Card title="Payloads reference" icon="message-dots" href="/reference/payloads">
    Learn about the components of each message.
  </Card>
