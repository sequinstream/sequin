...
<Steps>
  ...
  <Step title="Add filters and transformations">
    You can add [SQL filters](/reference/filters) to capture a subset of the source table.
  ...
  <Step title="Configure sink-specific settings">
    ...
    * [Redis](/reference/sinks/redis) sinks: Specify your Redis credentials and key to deliver messages to.
    * [Sequin Stream](/reference/sinks/sequin-stream) sinks: Specify your Sequin Stream to deliver messages to.
    * [SQS](/reference/sinks/sqs) sinks: Specify your SQS queue to deliver messages to.
