  ...
  <Step title="See changes flow to your Event Hub" icon="waveform-lines">
    ...
    <Step title="Messages tab">
      ...
      <Step title="View in Azure Portal">
        ...
        You should see a list of events. Click on any event to view its details, including its body. The messages are [`read` events](/reference/messages#change-messages) from the initial backfill of the `products` table.
