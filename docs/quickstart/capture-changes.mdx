...
<Steps titleSize="h2">
  <Step title="Create a Change Capture Pipeline" icon="list">
    ...
    2. Under "Source configuration", the `public.regions` table should be selected already:
        ...
        <Frame>
          <img src="/images/quickstart/wal-pipeline-source-config.png" alt="Select Change Capture Pipeline source" />
        </Frame>
    ...
    8. Give your Change Capture Pipeline a name (i.e. `region_to_sequin_events`) and click **Create Change Capture Pipeline**.
