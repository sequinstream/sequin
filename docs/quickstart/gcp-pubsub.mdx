...
description: 'Stream Postgres changes to a Google Cloud Pub/Sub topic'
---
  ...
  <Step title="See changes flow to your Pub/Sub topic" icon="waveform-lines">
    ...
    <Step title="Messages tab">
      ...
      <Step title="View in Pub/Sub Console">
        ...
        You should see a list of messages appear in the table below. The messages are [`read` events](/reference/messages#change-messages) from the initial backfill of the `products` table.
