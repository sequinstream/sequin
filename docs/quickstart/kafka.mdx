...
<Steps titleSize="h2">
 <Step title="Boot Kafka (optional)" icon="database">
  ...
  1. Download our <a href="https://github.com/sequinstream/sequin/raw/main/docs/static/docker-compose.yaml" download="docker-compose.yaml">Docker compose file for Kafka</a> (right click, save link as...).
 ...
 <Step title="Create a Kafka Sink" icon="database">
  ...
  <Steps>
    ...
    <Step title='Configure "Kafka Configuration"'>
      ...
      - Hosts: If running locally with the provided docker-compose, use `localhost:9092`
