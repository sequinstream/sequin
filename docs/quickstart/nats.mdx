...
sidebarTitle: 'NATS'
description: 'Stream Postgres changes to a NATS subject'
---
  ...
  <Step title="See changes flow to your NATS subject" icon="waveform-lines">
    ...
    <Step title="Messages tab">
      ...
      <Step title="Check your NATS subscription">
        ...
        These are [`read` events](/reference/messages#change-messages) from the initial backfill of the `products` table.
