 ...
 <Step title="Create a Redis String Sink" icon="database">
  ...
  <Steps>
    ...
    <Step title="Add a transform">
      Open the **Transform** card, click **+ Create new transform** and use the following Elixir function in a [Function transform](/reference/transforms#function-transform):
      ...
      Name the transform `record-only` and click **Create transform**.
    </Step>
