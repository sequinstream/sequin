...
sidebarTitle: 'Redis'
description: 'Stream Postgres changes to a Redis stream in minutes. Build real-time data pipelines with Redis and Postgres change data capture (CDC).'
---
...
By the end, you'll have hands-on experience setting up Postgres change data capture (CDC) with Sequin. This same pattern can be used to setup your own Postgres CDC pipeline with Redis.
