...
You are running Sequin, connected to a playground database, and have a Stream setup for the `regions` table. Now for the fun part – streaming! You can stream rows via a Webhook Subscription or the Consume API:
