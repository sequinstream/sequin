  ...
  <Step title="See changes flow to your SQS queue" icon="waveform-lines">
    ...
    <Step title="Messages tab">
      ...
      <Step title="View in SQS Console">
        ...
        Click on a message to view its contents. The messages are [`read` events](/reference/payloads#change-messages) from the initial backfill of the `products` table.
