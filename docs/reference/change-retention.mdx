...
You can also configure column selection to exclude or include specific columns from being synced. This allows you to exclude sensitive columns or irrelevant metadata columns, or include only the specific columns you need. You can either:
