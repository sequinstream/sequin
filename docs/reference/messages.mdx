...
description: 'Master Sequin's CDC message formats for real-time data processing. Detailed reference for change and row message structures with JSON examples for inserts, updates, and deletes.'
---
