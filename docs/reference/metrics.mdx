...
<Note>
  ...
  Set `SEQUIN_METRICS_USERNAME` and `SEQUIN_METRICS_PASSWORD` environment variables and Sequin will automatically require these credentials. See the [Configuration](/reference/configuration) reference for details.
</Note>
