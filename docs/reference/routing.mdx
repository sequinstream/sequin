...
When you create a routing function, you define an Elixir function that inspects the message and returns routing information. Sequin will use this information to determine the destination for each message.
...
<Frame>
  <img style={{maxWidth: '600px'}} src="/images/reference/routing-function-test.jpg" alt="Testing a routing function" />
</Frame>
