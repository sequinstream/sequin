...
destination:
  ...
  port: 3306
  database: "analytics"
  table_name: "events"             # Fallback table name
  username: "mysql_user"
...
When using `routing_mode: "dynamic"`, attach a [routing function](#routing-function-example) to dynamically determine the target table based on your data.
