...
1. [**SQL Enrichment functions**](/reference/sql-enrichment) - Enrich your messages with additional data
...
```yaml
functions:
  # SQL Enrichment function example
  - name: "my-sql-enrichment-function"
    description: "Enrich with customer data"
    type: "sql_enrichment"
    code: |-                          # Required for SQL Enrichment functions
      SELECT
        u.id,
