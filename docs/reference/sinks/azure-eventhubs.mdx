...
description: "Reference for the Azure Event Hubs sink"
---
...
When you configure an Event Hubs sink in Sequin, you can specify message grouping behavior. This will be used to determine which partition messages are sent to.
