...
description: "Reference for the GCP Pub/Sub sink"
---
...
Sequin sends messages to Pub/Sub as JSON. You can find the shape of the messages in the [messages reference](/reference/messages).
