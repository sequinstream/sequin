...
description: "Reference for the RabbitMQ sink"
---
...
<Info>
  Support for authenticated connections is coming soon. Upvote or comment on [this issue](https://github.com/sequin-io/sequin/issues/733) and we'll prioritize it.
</Info>
