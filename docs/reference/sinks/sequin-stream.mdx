...
Alternatively, if your consumer is unable to process the messages, it can [`nack`](/consume/consume-api/nack) them. This tells Sequin to make the messages available for processing again right away:
