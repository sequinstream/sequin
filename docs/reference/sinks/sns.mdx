...
By default, Sequin publishes JSON‑encoded messages that match the [messages reference](/reference/messages). You can configure [transforms](/reference/transforms) to customize the message format.
