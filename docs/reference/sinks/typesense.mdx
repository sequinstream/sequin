...
- **Timeout (seconds)** (optional)
    ...
    Typesense writes are synchronous, and [Typesense recommends](https://typesense.org/docs/guide/syncing-data-into-typesense.html#client-side-timeouts)
    using long client timeouts of up to 60 minutes if you are importing large batches.
