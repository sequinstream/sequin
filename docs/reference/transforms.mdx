...
Path transform are the simplest transform. Path transforms allow you to extract one field from your message using a dot-notation path. This is useful for:
