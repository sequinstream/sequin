...
description: "Such as logging changes to user accounts"
icon: "bars-staggered"
iconType: "solid"
---
...
<Card icon="flask-round-potion" iconType="solid">
  ...
  <br/>Please send us an email at <a href="mailto:founders@sequinstream.com">founders@sequinstream.com</a> if you are interested in working with us as we develop the feature, or want early access.
</Card>
