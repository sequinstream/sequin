defmodule Sequin.Prometheus do
  ...
  @spec observe_ingestion_latency(replication_slot_id :: String.t(), slot_name :: String.t(), latency_ms :: number()) ::
          :ok
  def observe_ingestion_latency(replication_slot_id, slot_name, latency_ms) do
    Gauge.set([name: :sequin_ingestion_latency_ms, labels: [replication_slot_id, slot_name]], latency_ms)
  end

  @spec observe_internal_latency(consumer_id :: String.t(), consumer_name :: String.t(), latency_ms :: number()) :: :ok
  def observe_internal_latency(consumer_id, consumer_name, latency_ms) do
    Histogram.observe([name: :sequin_internal_latency_ms, labels: [consumer_id, consumer_name]], latency_ms)
  end
  ...
  def observe_delivery_latency(consumer_id, consumer_name, success, latency_ms) do
    validate_success(success)
    Histogram.observe([name: :sequin_delivery_latency_ms, labels: [consumer_id, consumer_name, success]], latency_ms)
  end

  @spec observe_post_delivery_latency(consumer_id :: String.t(), consumer_name :: String.t(), latency_ms :: number()) ::
          :ok
  def observe_post_delivery_latency(consumer_id, consumer_name, latency_ms) do
    Histogram.observe([name: :sequin_post_delivery_latency_ms, labels: [consumer_id, consumer_name]], latency_ms)
  end
