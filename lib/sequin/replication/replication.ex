defmodule Sequin.Replication do
  ...
  def add_info(%PostgresReplicationSlot{} = pg_replication) do
    ...
    last_committed_at = SlotProcessor.get_last_committed_at(pg_replication.id)
  ...
  def put_low_watermark_wal_cursor!(replication_slot_id, %{commit_lsn: commit_lsn, commit_idx: commit_idx}) do
    Redis.command!(["SET", low_watermark_wal_cursor_key(replication_slot_id), "#{commit_lsn}:#{commit_idx}"])
  end
