defmodule Sequin.Runtime.SlotMessageStoreBehaviour do
  ...
  @callback messages_succeeded(SinkConsumer.t(), list(ConsumerEvent.t())) ::
  ...
  @callback messages_already_succeeded(SinkConsumer.t(), list(ConsumerEvent.t())) ::
              {:ok, non_neg_integer()} | {:error, Exception.t()}

  @callback messages_failed(SinkConsumer.t(), list(ConsumerEvent.t())) ::
