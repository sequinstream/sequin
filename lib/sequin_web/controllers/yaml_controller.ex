defmodule SequinWeb.YamlController do
  ...
  defp get_resource_type(%DestinationConsumer{}), do: "webhook_subscription"
  ...
  defp same_resource?(%DestinationConsumer{name: name}, %DestinationConsumer{name: name}), do: true
