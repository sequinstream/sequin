defmodule Sequin.Factory.ConsumersFactory do
    ...
    merge_attributes(
      %ConsumerEventData{
        ...
        metadata: %ConsumerEventData.Metadata{
          ...
          commit_lsn: Factory.unique_integer(),
          sink: %ConsumerEventData.Metadata.Sink{
            id: Factory.uuid(),
            name: Factory.word()
          }
        }
    ...
    merge_attributes(
      %ConsumerRecordData{
        ...
        metadata: %ConsumerRecordData.Metadata{
          ...
          commit_timestamp: Factory.timestamp(),
          commit_lsn: Factory.unique_integer(),
          sink: %ConsumerRecordData.Metadata.Sink{
            id: Factory.uuid(),
            name: Factory.word()
          }
        }
  ...
  def transform(attrs \\ []) do
    ...
    {sequence_id, attrs} =
      Map.pop_lazy(attrs, :sequence_id, fn ->
        DatabasesFactory.insert_sequence!(account_id: account_id).id
      end)
